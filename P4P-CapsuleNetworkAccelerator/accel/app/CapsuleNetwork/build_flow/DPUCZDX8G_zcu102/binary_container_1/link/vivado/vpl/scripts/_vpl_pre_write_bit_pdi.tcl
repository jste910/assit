...
if { ![report_timing_and_scale_freq "" "dr" $vivado_output_dir $vpl_output_dir "kernel_clock_freqs {} system_clock_freqs {} worst_negative_slack -1 max_frequency 650 min_frequency 10 error_on_hold_violation true error_on_pw_violation true skip_timing_and_scaling true enable_auto_freq_scale false" "binary_container_1"] } {
  return false
}
