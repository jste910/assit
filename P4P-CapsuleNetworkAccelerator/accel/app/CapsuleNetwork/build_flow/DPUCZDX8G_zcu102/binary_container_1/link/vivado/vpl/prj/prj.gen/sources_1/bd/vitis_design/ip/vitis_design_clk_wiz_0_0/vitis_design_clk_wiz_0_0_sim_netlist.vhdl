...
-- Command     : write_vhdl -force -mode funcsim -rename_top vitis_design_clk_wiz_0_0 -prefix
--               vitis_design_clk_wiz_0_0_ vitis_design_clk_wiz_0_0_sim_netlist.vhdl
...
entity vitis_design_clk_wiz_0_0_vitis_design_clk_wiz_0_0_clk_wiz is
  port (
...
end vitis_design_clk_wiz_0_0_vitis_design_clk_wiz_0_0_clk_wiz;

architecture STRUCTURE of vitis_design_clk_wiz_0_0_vitis_design_clk_wiz_0_0_clk_wiz is
  signal clk_in1_vitis_design_clk_wiz_0_0 : STD_LOGIC;
  signal clk_out1_vitis_design_clk_wiz_0_0 : STD_LOGIC;
  signal clk_out2_vitis_design_clk_wiz_0_0 : STD_LOGIC;
  signal clk_out3_vitis_design_clk_wiz_0_0 : STD_LOGIC;
  signal clk_out4_vitis_design_clk_wiz_0_0 : STD_LOGIC;
  signal clk_out5_vitis_design_clk_wiz_0_0 : STD_LOGIC;
  signal clk_out6_vitis_design_clk_wiz_0_0 : STD_LOGIC;
  signal clk_out7_vitis_design_clk_wiz_0_0 : STD_LOGIC;
...
clkin1_ibuf: unisim.vcomponents.IBUF
    generic map(
      IOSTANDARD => "DEFAULT"
        ...
        port map (
      I => clk_in1,
      O => clk_in1_vitis_design_clk_wiz_0_0
    );
clkout1_buf: unisim.vcomponents.BUFGCE
    generic map(
      ...
      SIM_DEVICE => "ULTRASCALE_PLUS"
        ...
        port map (
      CE => '1',
      I => clk_out1_vitis_design_clk_wiz_0_0,
      O => clk_out1
    );
clkout2_buf: unisim.vcomponents.BUFGCE
    generic map(
      ...
      SIM_DEVICE => "ULTRASCALE_PLUS"
        ...
        port map (
      CE => '1',
      I => clk_out2_vitis_design_clk_wiz_0_0,
      O => clk_out2
    );
clkout3_buf: unisim.vcomponents.BUFGCE
    generic map(
      ...
      SIM_DEVICE => "ULTRASCALE_PLUS"
        ...
        port map (
      CE => '1',
      I => clk_out3_vitis_design_clk_wiz_0_0,
      O => clk_out3
    );
clkout4_buf: unisim.vcomponents.BUFGCE
    generic map(
      ...
      SIM_DEVICE => "ULTRASCALE_PLUS"
        ...
        port map (
      CE => '1',
      I => clk_out4_vitis_design_clk_wiz_0_0,
      O => clk_out4
    );
clkout5_buf: unisim.vcomponents.BUFGCE
    generic map(
      ...
      SIM_DEVICE => "ULTRASCALE_PLUS"
        ...
        port map (
      CE => '1',
      I => clk_out5_vitis_design_clk_wiz_0_0,
      O => clk_out5
    );
clkout6_buf: unisim.vcomponents.BUFGCE
    generic map(
      ...
      SIM_DEVICE => "ULTRASCALE_PLUS"
        ...
        port map (
      CE => '1',
      I => clk_out6_vitis_design_clk_wiz_0_0,
      O => clk_out6
    );
clkout7_buf: unisim.vcomponents.BUFGCE
    generic map(
      ...
      SIM_DEVICE => "ULTRASCALE_PLUS"
        ...
        port map (
      CE => '1',
      I => clk_out7_vitis_design_clk_wiz_0_0,
      O => clk_out7
    );
mmcme4_adv_inst: unisim.vcomponents.MMCME4_ADV
    generic map(
      ...
      CLKIN1 => clk_in1_vitis_design_clk_wiz_0_0,
      CLKIN2 => '0',
      CLKINSEL => '1',
      CLKINSTOPPED => NLW_mmcme4_adv_inst_CLKINSTOPPED_UNCONNECTED,
      CLKOUT0 => clk_out1_vitis_design_clk_wiz_0_0,
      CLKOUT0B => NLW_mmcme4_adv_inst_CLKOUT0B_UNCONNECTED,
      CLKOUT1 => clk_out2_vitis_design_clk_wiz_0_0,
      CLKOUT1B => NLW_mmcme4_adv_inst_CLKOUT1B_UNCONNECTED,
      CLKOUT2 => clk_out3_vitis_design_clk_wiz_0_0,
      CLKOUT2B => NLW_mmcme4_adv_inst_CLKOUT2B_UNCONNECTED,
      CLKOUT3 => clk_out4_vitis_design_clk_wiz_0_0,
      CLKOUT3B => NLW_mmcme4_adv_inst_CLKOUT3B_UNCONNECTED,
      CLKOUT4 => clk_out5_vitis_design_clk_wiz_0_0,
      CLKOUT5 => clk_out6_vitis_design_clk_wiz_0_0,
      CLKOUT6 => clk_out7_vitis_design_clk_wiz_0_0,
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity vitis_design_clk_wiz_0_0 is
  port (
    clk_out1 : out STD_LOGIC;
    clk_out2 : out STD_LOGIC;
    clk_out3 : out STD_LOGIC;
  ...
  attribute NotValidForBitStream of vitis_design_clk_wiz_0_0 : entity is true;
end vitis_design_clk_wiz_0_0;

architecture STRUCTURE of vitis_design_clk_wiz_0_0 is
begin
inst: entity work.vitis_design_clk_wiz_0_0_vitis_design_clk_wiz_0_0_clk_wiz
     port map (
      clk_in1 => clk_in1,
      clk_out1 => clk_out1,
      clk_out2 => clk_out2,
