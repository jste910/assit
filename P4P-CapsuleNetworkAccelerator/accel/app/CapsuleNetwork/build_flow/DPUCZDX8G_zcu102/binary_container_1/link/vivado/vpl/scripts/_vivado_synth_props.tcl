...
if { [llength $run] == 0 } {
  puts "WARNING: there is no run that matches the run name 'synth_1' in --xp vivado_prop value"
} else {
  set_property -name STEPS.SYNTH_DESIGN.ARGS.FLATTEN_HIERARCHY -value full -objects $run
}
