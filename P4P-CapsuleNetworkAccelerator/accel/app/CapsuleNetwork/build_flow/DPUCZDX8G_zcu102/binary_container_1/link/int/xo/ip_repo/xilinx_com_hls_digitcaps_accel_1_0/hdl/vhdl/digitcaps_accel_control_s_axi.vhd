...
entity digitcaps_accel_control_s_axi is
generic (
...
end entity digitcaps_accel_control_s_axi;
...
architecture behave of digitcaps_accel_control_s_axi is
    ...
    constant ADDR_PREDICTION_DATA_0 : INTEGER := 16#28#;
    constant ADDR_PREDICTION_DATA_1 : INTEGER := 16#2c#;
    constant ADDR_PREDICTION_CTRL   : INTEGER := 16#30#;
...
-- ----------------------- Register logic ----------------
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ARESET = '1') then
                int_prediction(31 downto 0) <= (others => '0');
            elsif (ACLK_EN = '1') then
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ARESET = '1') then
                int_prediction(63 downto 32) <= (others => '0');
            elsif (ACLK_EN = '1') then
