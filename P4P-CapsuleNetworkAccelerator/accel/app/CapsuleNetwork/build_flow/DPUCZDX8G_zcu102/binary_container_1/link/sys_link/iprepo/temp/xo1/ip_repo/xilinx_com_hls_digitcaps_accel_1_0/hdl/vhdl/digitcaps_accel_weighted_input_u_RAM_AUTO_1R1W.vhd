...
entity digitcaps_accel_weighted_input_u_RAM_AUTO_1R1W is 
    generic(
        MEM_TYPE        : string    := "auto"; 
        DataWidth       : integer   := 32; 
        AddressWidth    : integer   := 15;
        AddressRange    : integer   := 23040
    ); 
    port (
...
architecture rtl of digitcaps_accel_weighted_input_u_RAM_AUTO_1R1W is 
